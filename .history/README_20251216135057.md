...
![Configuração da VPC](./assets/vpc-configuracao-1.jpg)
...
![Security Group Database](./assets/vpc-db-security-group-3.jpg)
...
![Política de Confiança IAM](./assets/IAM-politica-de-seguranca-11.jpg)
...
![Seleção PostgreSQL](./assets/db-criacao-rds-6.jpg)
...
![Configuração de Credenciais](./assets/rds-configuracao-senha-7.jpg)
...
![Bucket S3 Criado](./assets/s3-bucket-criado-10.jpg)
...
![Conexão SSH Git Bash](./assets/ec2-conexao-ssh-5.jpg)
...
![Instalação Node.js e Pacotes](./assets/ssh-preparando-ambiente-12.jpg)
...
![Conexão com Sucesso](./assets/rds-conexao-feita-13.jpg)
...
![Tabela Criada e Dados Inseridos](./assets/rds-tabela-criada-14.jpg)
